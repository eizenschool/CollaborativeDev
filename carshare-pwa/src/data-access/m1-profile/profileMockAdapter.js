...
export const profileMockAdapter = {
  ...
  adminGetReputationSummary: (...args) => mockDb.adminGetReputationSummary(...args),
  adminApplyConductOutcome: (...args) => mockDb.adminApplyConductOutcome(...args),
  adminClearReputationHold: (...args) => mockDb.adminClearReputationHold(...args),
  ...
  adminListUnverifiedMembers: (...args) => mockDb.adminListUnverifiedMembers(...args),
  adminApplyIdentityOverduePenalty: (...args) => mockDb.adminApplyIdentityOverduePenalty(...args),
  submitSafetyReport: (...args) => mockDb.submitSafetyReport(...args),
  adminListSafetyReports: (...args) => mockDb.adminListSafetyReports(...args),
  adminResolveSafetyReport: (...args) => mockDb.adminResolveSafetyReport(...args),
