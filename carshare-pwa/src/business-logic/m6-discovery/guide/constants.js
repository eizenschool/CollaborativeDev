...
} from '../../../data-access/m6-discovery/guidePersistenceConfig.js';
...
export const GUIDE_LIMITS = Object.freeze({
  ...
  REQUEST_TIMEOUT_MS: GUIDE_REQUEST_TIMEOUT_MS,
  SESSION_RETENTION_DAYS: GUIDE_SESSION_RETENTION_DAYS,
...
export const GUIDE_STORAGE = Object.freeze({
  FIXTURE_KEY: GUIDE_FIXTURE_STORAGE_KEY,
