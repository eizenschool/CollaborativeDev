...
describe('fetchForecasts', () => {
  ...
  it('makes no external request in test/fixture mode without an injected transport', async () => {
    const fetchSpy = vi.spyOn(globalThis, 'fetch');
    const result = await fetchForecasts([place('p_park', CATEGORY.NATURE)], '2026-08-20');
