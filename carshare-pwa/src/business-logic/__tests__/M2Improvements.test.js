...
const migration = new URL('../../../database/sql/041_m2_adaptive_checkin.sql', import.meta.url);
const trackingMigration = new URL('../../../database/sql/042_m2_live_location_tracking.sql', import.meta.url);
const correctnessMigration = new URL('../../../database/sql/049_m2_tracking_correctness_fixes.sql', import.meta.url);
const adminRemovalMigration = new URL('../../../database/sql/050_m2_remove_trust_admin.sql', import.meta.url);
const familyCryptoMigration = new URL('../../../database/sql/052_m2_fix_family_link_crypto_schema.sql', import.meta.url);
