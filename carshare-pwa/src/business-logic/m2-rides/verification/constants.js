// ===== BUSINESS LOGIC LAYER (M2 Ride Verification Constants) =====
// These rules originated in the former Module 6 Trust & Safety scope and are now
// owned by Module 2. Every verification threshold lives here, and nowhere else.
//
...
import {
  ...
  GPS_RESULT,
  VERIFICATION_STATUS,
} from '../../../data-access/m2-rides/verificationPersistenceContract.js';

export { DISPUTE_STATUS, EXCHANGE_OUTCOME, GPS_RESULT, VERIFICATION_STATUS };
