...
export default function EditRide() {
  ...
  return (
    <main className="phone-ride-page edit-ride-page">
      ...
      {!locked && <div className="ride-bottom-actions"><button type="button" className="primary-action full" disabled={saving || saved} onClick={save}>{saved ? '✓ Changes saved' : saving ? 'Saving…' : 'Save changes'}</button></div>}
    </main>
  );
}
