...
const cards = readFileSync(resolve(import.meta.dirname, '../components/RideCards.jsx'), 'utf8')
const search = readFileSync(resolve(import.meta.dirname, '../components/SearchModule.jsx'), 'utf8')
