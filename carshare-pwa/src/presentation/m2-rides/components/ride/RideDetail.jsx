...
import { getAuthNavigation, normaliseInternalReturnPath } from '../../../../business-logic/m1-profile/authAccess.js';
...
import { RideReviewService } from '../../../../business-logic/m2-rides/RideReviewService.js';
import { PlacePhotoService } from '../../../../business-logic/shared/PlacePhotoService.js';
import { RideLiveTrackingService, isPointStale, isPointUnavailable } from '../../../../business-logic/m2-rides/RideLiveTrackingService.js';
import { isAtLeastHoursAway, isBeforeRideExpiry, REQUEST_CUTOFF_HOURS } from '../../../../business-logic/m2-rides/rideDateTime.js';
import { GoogleMapsEmbedService } from '../../../../business-logic/shared/GoogleMapsEmbedService.js';
import { MessagingService } from '../../../../business-logic/m3-messaging/MessagingService.js';
import { IdentityVerificationService } from '../../../../business-logic/m1-profile/IdentityVerificationService.js';
import { formatJourneyCountdown, getRideJourneyState, isTripModeEligible, RIDE_ACTION } from '../../../../business-logic/m2-rides/rideJourneyState.js';
import GoogleRouteMap from '../../../shared/components/maps/GoogleRouteMap.jsx';
...
export default function RideDetail() {
  ...
  const loadDetail = useCallback(async ({ silent = false } = {}) => {
    ...
    try {
      ...
      if (userId && found.status === 'Completed') {
        setReviewEligibility(await RideReviewService.getEligibility(userId, rideId).catch(() => null));
      } else {
        setReviewEligibility(null);
      }
      if (userId && found.hostId === userId) {
        ...
        const requests = await RideRequestService.listMyRequests(userId);
  ...
  // A same-account auth/profile refresh must not rerun the blocking initial
  // load: unmounting Trip Mode also stops its consented location watcher.
  }, [rideId, userId]);
