...
const hub = read('src/presentation/m2-rides/components/ride/RideHub.jsx');
const card = read('src/presentation/m2-rides/components/ride/RideCard.jsx');
const detail = read('src/presentation/m2-rides/components/ride/RideDetail.jsx');
const publish = read('src/presentation/m2-rides/components/ride/PublishRide.jsx');
const requests = read('src/presentation/m2-rides/components/ride/ManageRequests.jsx');
const styles = read('src/presentation/m2-rides/styles/ride.css');
