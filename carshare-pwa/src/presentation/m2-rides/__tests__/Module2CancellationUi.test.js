...
const myRequests = read('src/presentation/m2-rides/components/ride/MyRequests.jsx');
const rideDetail = read('src/presentation/m2-rides/components/ride/RideDetail.jsx');
const rideStyles = read('src/presentation/m2-rides/styles/ride.css');
