...
import {
  ...
  RouteFocusManager,
  RouteLoading,
} from '../components/ui/RouteState.jsx';
const SwipeRouteViewport = lazy(() => import('../components/ui/SwipeRouteViewport.jsx'));

const AuthPage = lazy(() => import('../../m1-profile/components/AuthPage.jsx'));
const HomeScreen = lazy(() => import('../../m6-discovery/HomeScreen.jsx'));
const MyProfile = lazy(() => import('../../m1-profile/components/MyProfile.jsx'));
const PublicProfile = lazy(() => import('../../m1-profile/components/PublicProfile.jsx'));
const RideHub = lazy(() => import('../../m2-rides/components/ride/RideHub.jsx'));
const PublishRide = lazy(() => import('../../m2-rides/components/ride/PublishRide.jsx'));
const SafetyRoutes = lazy(() => import('../../m2-rides/components/verification/SafetyRoutes.jsx'));
const DiscoverRoutes = lazy(() => import('../../m6-discovery/components/discover/DiscoverRoutes.jsx'));
const GuideRoutes = lazy(() => import('../../m6-discovery/components/guide/GuideRoutes.jsx'));
const RideDetail = lazy(() => import('../../m2-rides/components/ride/RideDetail.jsx'));
const ManageRequests = lazy(() => import('../../m2-rides/components/ride/ManageRequests.jsx'));
const MyRequests = lazy(() => import('../../m2-rides/components/ride/MyRequests.jsx'));
const EditRide = lazy(() => import('../../m2-rides/components/ride/EditRide.jsx'));
const RateReview = lazy(() => import('../../m2-rides/components/ride/RateReview.jsx'));
const MessageModule = lazy(() => import('../../m3-messaging/components/MessageModule.jsx'));
const FriendCenter = lazy(() => import('../../m3-messaging/components/FriendCenter.jsx'));
const TripModule = lazy(() => import('../../m5-trips/components/TripModule.jsx'));
const TripDetail = lazy(() => import('../../m5-trips/components/TripDetail.jsx'));
const NotificationCenter = lazy(() => import('../components/notifications/NotificationCenter.jsx'));
const SearchModule = lazy(() => import('../../m4-search/components/SearchModule.jsx'));
const FavouritePage = lazy(() => import('../../m4-search/components/FavouritePage.jsx'));
const FamilyLocationShare = lazy(() => import('../../m2-rides/components/ride/FamilyLocationShare.jsx'));
