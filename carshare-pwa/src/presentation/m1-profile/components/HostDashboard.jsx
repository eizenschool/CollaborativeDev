...
import { HostImpactEngine } from '../../../business-logic/m1-profile/HostImpactEngine.js';
import { IconCar, IconMedal, IconCheck, IconTrendUp, IconTrendDown, IconBolt, IconLeaf } from '../../shared/components/icons.jsx';
    ...
    <>
      ...
      <div className="content-body">
        <button className="btn-primary" style={{ marginBottom: 16 }} onClick={() => alert('Publish New Ride belongs to Module 4/5 - out of scope for this Module 1 build.')}>
          <IconCar size={16} /> Publish New Ride
        </button>

        <div className="card">
          <div className="impact-header">
            <div className="impact-badge-icon"><IconMedal size={22} /></div>
          ...
          <ul className="perk-list">
            {summary.badge.perks.map((p) => (
              <li key={p}><span className="perk-check"><IconCheck size={14} /></span>{p}</li>
            ))}
          </ul>
          ...
          {HostImpactEngine.backend === 'mock' && (
            <div className="demo-controls" style={{ marginTop: 18 }}>
              ...
              <button className="btn-block demo-down" onClick={() => adjust(-8, -12)}><IconTrendDown size={15} /> −8 trips, −12 rep score</button>
        ...
        <div className="card">
          <p className="card-title formula-title"><IconBolt size={15} /> Impact Score Formula</p>

          <div className="formula-row">
            <span className="formula-icon"><IconCar size={16} /></span>
            <div>
          ...
          <div className="formula-row">
            <span className="formula-icon"><IconLeaf size={16} /></span>
            <div>
