...
import { IdentityDocumentPreview } from '../IdentityVerificationCard.jsx';
  ...
  return (
    <div className="card" style={{ marginBottom: 20 }}>
      ...
      <ul className="reputation-rules" style={{ marginBottom: 18 }}>
        <li>{submission.documentType === 'passport' ? 'Passport' : 'MyKad'} {submission.documentNumber || submission.icNumber || 'not recorded'}</li>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
        <IdentityDocumentPreview path={submission.documentPath} label={submission.documentType === 'passport' ? 'Passport photo' : 'MyKad photo'} />
        {(submission.licenseDocumentPath || submission.licenseExpiry) && <IdentityDocumentPreview path={submission.licenseDocumentPath} label="Driving licence photo" />}
