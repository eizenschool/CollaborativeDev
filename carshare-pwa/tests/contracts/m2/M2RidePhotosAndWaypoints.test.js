...
import {
  ...
  validatePickupPhoto,
} from '../../../src/business-logic/m2-rides/RidePickupPhotoService.js';
import { validWaypointStopMinutes } from '../../../src/presentation/m2-rides/components/ride/PublishRide.jsx';
...
const publishRide = new URL('../../../src/presentation/m2-rides/components/ride/PublishRide.jsx', import.meta.url);
const rideCard = new URL('../../../src/presentation/m2-rides/components/ride/RideCard.jsx', import.meta.url);
const searchCards = new URL('../../../src/presentation/m4-search/components/RideCards.jsx', import.meta.url);
const rideRequestService = new URL('../../../src/business-logic/m2-rides/RideRequestService.js', import.meta.url);
const destinationPhoto = new URL('../../../src/presentation/m2-rides/components/ride/DestinationRidePhoto.jsx', import.meta.url);
const rideDetail = new URL('../../../src/presentation/m2-rides/components/ride/RideDetail.jsx', import.meta.url);
