...
import { matchesSOSSafeConfirmation, SOS_SAFE_CONFIRMATION } from '../../../src/presentation/m2-rides/components/ride/RideSOSPanel.jsx';
...
const sosPanel = new URL('../../../src/presentation/m2-rides/components/ride/RideSOSPanel.jsx', import.meta.url);
const sosController = new URL('../../../src/presentation/m2-rides/components/ride/useRideSOSController.js', import.meta.url);
const globalLauncher = new URL('../../../src/presentation/m2-rides/components/ride/GlobalSOSLauncher.jsx', import.meta.url);
const globalLauncherStyles = new URL('../../../src/presentation/m2-rides/styles/sos-launcher.css', import.meta.url);
const topNav = new URL('../../../src/presentation/shared/components/nav/TopNav.jsx', import.meta.url);
const main = new URL('../../../src/main.jsx', import.meta.url);
const invitePage = new URL('../../../src/presentation/m2-rides/components/ride/TrustedFamilyInvite.jsx', import.meta.url);
const familyPage = new URL('../../../src/presentation/m2-rides/components/ride/SOSFamilyView.jsx', import.meta.url);
const familyMapPanel = new URL('../../../src/presentation/m2-rides/components/ride/FamilyLiveMapPanel.jsx', import.meta.url);
const sosAlertOverlay = new URL('../../../src/presentation/m2-rides/components/ride/SOSAlertOverlay.jsx', import.meta.url);
const notificationContext = new URL('../../../src/presentation/shared/context/NotificationContext.jsx', import.meta.url);
