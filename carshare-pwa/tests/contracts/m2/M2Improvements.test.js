...
import { buildAutocompleteRequest, createMapDiagnostic } from '../../../src/business-logic/shared/GooglePlacesService.js';
import { queryWaypointRecommendations } from '../../../src/business-logic/m2-rides/M2WaypointRecommendationService.js';
import { RideLiveTrackingService } from '../../../src/business-logic/m2-rides/RideLiveTrackingService.js';
import { PlaceQueryService } from '../../../src/business-logic/m6-discovery/discovery/PlaceQueryService.js';
import { buildReplay, HISTORY_PAGE_SIZE } from '../../../src/presentation/m5-trips/components/TripRouteReplay.jsx';
...
const rideDetailComponent = new URL('../../../src/presentation/m2-rides/components/ride/RideDetail.jsx', import.meta.url);
const safetyRoutesComponent = new URL('../../../src/presentation/m2-rides/components/verification/SafetyRoutes.jsx', import.meta.url);
const publishRideComponent = new URL('../../../src/presentation/m2-rides/components/ride/PublishRide.jsx', import.meta.url);
const mockStore = new URL('../../../src/data-access/shared/fixture/legacyMockDataStore.js', import.meta.url);
const replayComponent = new URL('../../../src/presentation/m5-trips/components/TripRouteReplay.jsx', import.meta.url);
const liveMapComponent = new URL('../../../src/presentation/m2-rides/components/maps/LiveRideMap.jsx', import.meta.url);
const familyShareComponent = new URL('../../../src/presentation/m2-rides/components/ride/FamilyLocationShare.jsx', import.meta.url);
const familyMapPanel = new URL('../../../src/presentation/m2-rides/components/ride/FamilyLiveMapPanel.jsx', import.meta.url);
const rideStyles = new URL('../../../src/presentation/m2-rides/styles/ride.css', import.meta.url);
