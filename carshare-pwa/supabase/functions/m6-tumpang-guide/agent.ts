...
const SEARCH_CATALOGUE_PARAMETERS = {
  ...
  required: ["originLabel", "partySize", "startDate", "endDate", "preferredCategories", "categoryMode", "recommendationMode", "nextQuestionField", ...Object.keys(LANGUAGE_PROPERTIES)]
};
