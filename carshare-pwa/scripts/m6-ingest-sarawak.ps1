# Sarawak, one region only - same discipline as m6-ingest-johor.ps1
# (docs/MODULE6-API-SETUP.md §8). Usage:
#   $env:SUPABASE_SECRET_KEY = "sb_secret_..."
#   .\scripts\m6-ingest-sarawak.ps1 -Step recon
#   .\scripts\m6-ingest-sarawak.ps1 -Step main -MaxDetails 20
...
$region = @{ id = 'sarawak'; state = 'Sarawak'; latitude = 1.5535; longitude = 110.3593; radiusMeters = 50000 }
...
if ($Step -eq 'recon') {
  ...
  Write-Host "  .\scripts\m6-ingest-sarawak.ps1 -Step main -MaxDetails <discovered, capped at 50>"
}
