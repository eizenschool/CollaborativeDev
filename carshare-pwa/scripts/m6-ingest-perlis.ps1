# Perlis, one region only - same discipline as m6-ingest-johor.ps1
# (docs/MODULE6-API-SETUP.md §8). Usage:
#   $env:SUPABASE_SECRET_KEY = "sb_secret_..."
#   .\scripts\m6-ingest-perlis.ps1 -Step recon
#   .\scripts\m6-ingest-perlis.ps1 -Step main -MaxDetails 20
...
$region = @{ id = 'perlis'; state = 'Perlis'; latitude = 6.4414; longitude = 100.1986; radiusMeters = 50000 }
...
if ($Step -eq 'recon') {
  ...
  Write-Host "  .\scripts\m6-ingest-perlis.ps1 -Step main -MaxDetails <discovered, capped at 50>"
}
