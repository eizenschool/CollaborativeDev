...
- Administrators dismiss, record a violation without deducting points, or apply the existing four severity tiers and escalation/hold policy. Recording a violation is an audit outcome, not a delivered warning notification. This change does not introduce a new account suspension, messaging ban or ride cancellation policy.
