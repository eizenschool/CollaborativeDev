...
1. `database/sql/041_m3_add_voice_calls.sql`
2. `database/sql/042_m3_turn_guard.sql`
3. `database/sql/043_m3_reliable_voice_call_delivery.sql`

`041` is not rerunnable. If `call_sessions already exists` appears, stop and
