...
-- 072_m1_reputation_events_and_eligibility.sql reset it (create schema if
...
-- Module 4 search/favourites, and 073_m1's own new profile RLS policies for
-- every anon/authenticated caller, not just Module 1's.

grant usage on schema private to anon, authenticated;

-- 073_m1_public_profile_visibility.sql revoked execute on this helper right
