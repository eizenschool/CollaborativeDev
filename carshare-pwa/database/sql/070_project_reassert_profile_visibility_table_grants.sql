...
-- Kept separate from 068_m1_public_profile_visibility.sql on purpose: that
-- file also revokes execute on private.profile_is_relevant_to_viewer, which
-- undoes 069_project_restore_private_schema_grants.sql's fix whenever 068
-- is re-run. Do not re-run 068 to fix a profile_visibility grant gap - run
